...
def beforeTriggerExec():
    DoActions([
        ...
        SetMemory(0x6562F8 + 52, SetTo, 18153472),
        SetMemory(0x6562F8 + 56, SetTo, 18678041),
        SetMemory(0x6562F8 + 60, SetTo, 19136800),
        SetMemory(0x6562F8 + 64, SetTo, 296),
        SetMemory(0x6562F8 + 68, SetTo, 301),
        ...
        SetMemory(0x665580 + 360, SetTo, 42860544),
        SetMemory(0x665580 + 364, SetTo, 658),
